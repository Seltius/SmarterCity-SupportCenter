      ...
      <div v-if="taskContext.taskInstance">
        <akip-show-task-instance :taskInstance="taskContext.taskInstance">
          <template v-slot:body>
            ...
            <div class="form-group">
              <label class="form-control-label" v-text="$t('smarterCitySupportCenterApp.fillSupportRequest.email')">email</label>
              <input
                readonly
                type="text"
                class="form-control"
        ...
        <router-link
          ...
          :to="`/process-definition/SupportProcess/task/FillSupportRequest/${taskContext.taskInstance.id}/execute`"
          tag="button"
...
<script lang="ts" src="./fill-support-request-details.component.ts"></script>
