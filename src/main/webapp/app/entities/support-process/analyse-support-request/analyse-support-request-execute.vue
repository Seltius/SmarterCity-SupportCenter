          ...
          <template v-slot:body>
            ...
            <div class="form-group">
              <label
                ...
                v-text="$t('smarterCitySupportCenterApp.analyseSupportRequest.supportId')"
                for="analyse-support-request-supportId"
                >Support Id</label
              >
              <input
                type="number"
                class="form-control"
                name="supportId"
                id="analyse-support-request-supportId"
                readonly
                data-cy="supportId"
                :class="{
            ...
            <div class="form-group">
              <label
                class="form-control-label"
                v-text="$t('smarterCitySupportCenterApp.analyseSupportRequest.createDate')"
                for="analyse-support-request-createDate"
                >Create Date</label
              >
              <b-input-group class="mb-3">
                <b-form-input
                  id="analyse-support-request-createDate"
                  readonly
                  data-cy="createDate"
                  type="text"
                  class="form-control"
            ...
            <div class="form-group">
              <label
                class="form-control-label"
                v-text="$t('smarterCitySupportCenterApp.analyseSupportRequest.name')"
                for="analyse-support-request-name"
                >Name</label
              >
              <input
                type="text"
                class="form-control"
                name="name"
                id="analyse-support-request-name"
                readonly
                data-cy="name"
                :class="{
            ...
            <div class="form-group">
              <label
                class="form-control-label"
                v-text="$t('smarterCitySupportCenterApp.analyseSupportRequest.email')"
                for="analyse-support-request-email"
                >Email</label
              >
              <input
                type="text"
                class="form-control"
                name="email"
                id="analyse-support-request-email"
                readonly
                data-cy="email"
                :class="{
            ...
            <div class="form-group">
              <label
                class="form-control-label"
                v-text="$t('smarterCitySupportCenterApp.analyseSupportRequest.issue')"
                for="analyse-support-request-issue"
                >Issue</label
              >
              <input
                type="text"
                class="form-control"
                name="issue"
                id="analyse-support-request-issue"
                readonly
                data-cy="issue"
                :class="{
            ...
            <div class="form-group">
              <label
                class="form-control-label"
                v-text="$t('smarterCitySupportCenterApp.analyseSupportRequest.isRefund')"
                for="analyse-support-request-isRefund"
                >Is Refund</label
              >
              <input
                type="checkbox"
                class="form-check"
                name="isRefund"
                id="analyse-support-request-isRefund"
                data-cy="isRefund"
                :class="{
                  valid: !$v.taskContext.supportProcess.support.isRefund.$invalid,
                  invalid: $v.taskContext.supportProcess.support.isRefund.$invalid,
                }"
                v-model="$v.taskContext.supportProcess.support.isRefund.$model"
              />
            </div>
          </template>
...
<script lang="ts" src="./analyse-support-request-execute.component.ts"></script>
