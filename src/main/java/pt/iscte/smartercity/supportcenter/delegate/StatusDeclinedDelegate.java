...
@Component
public class StatusDeclinedDelegate implements JavaDelegate {

    private static final Logger log = LoggerFactory.getLogger(StatusDeclinedDelegate.class);
    ...
    public void execute(DelegateExecution delegateExecution) throws Exception {
        log.info("RUNNING DELEGATE TASK: StatusDeclinedDelegate");
        ...
        supportProcess.getSupport().setStatus(Status.REFUND_DECLINED.getDescription());
