...
@Component
public class SupportMessageDelegate implements JavaDelegate {

    private static final Logger log = LoggerFactory.getLogger(SupportMessageDelegate.class);
    ...
    public void execute(DelegateExecution delegateExecution) throws Exception {
        log.info("RUNNING DELEGATE TASK: SupportMessageDelegate");
