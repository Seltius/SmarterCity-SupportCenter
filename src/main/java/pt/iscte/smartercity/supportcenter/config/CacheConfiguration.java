...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, pt.iscte.smartercity.supportcenter.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, pt.iscte.smartercity.supportcenter.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, pt.iscte.smartercity.supportcenter.domain.Message.class.getName());
            createCache(cm, pt.iscte.smartercity.supportcenter.domain.MessageProcess.class.getName());
